...
export const SYNTHETIC_SUCCESS_SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    refreshing: Object.freeze({ type: 'boolean' }),
    cacheStatus: Object.freeze({ enum: ['fresh', 'stale'] }),
...
function envelopeSchema(data) {
  return Object.freeze({
    ...
    properties: {
      ...
      sourceUpdatedAt: optionalText, dataStale: booleanValue, refreshing: booleanValue,
      cacheStatus: Object.freeze({ enum: ['fresh', 'stale'] }), isComplete: booleanValue,
      unavailableReasonCode: optionalText
    },
    additionalProperties: false
  });
