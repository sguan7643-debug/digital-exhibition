...
assert.deepEqual(Object.keys(contracts).sort(), [
  'ADM-003', 'ADM-004', 'ADM-006', 'ADM-007', 'ANN-001', 'ANN-002', 'ANN-003', 'ANN-005', 'APP-001', 'APP-002', 'APP-003', 'APP-007', 'APP-009', 'APP-010', 'ARC-002', 'CER-001', 'CER-002', 'CER-003',
  'COM-001', 'COM-002', 'COM-003', 'COM-004', 'COM-005', 'COM-010', 'FAV-001', 'FAV-002', 'INT-001', 'INT-003', 'INT-004', 'INT-005', 'MAT-001', 'MAT-002', 'MSG-001', 'MSG-002',
