...
async function mountSfc(file){
  ...
  code=code.replace(/import AppDetailAuthoritativeBody from ['"]\.\.\/components\/AppDetailAuthoritativeBody\.vue['"];?/,"const AppDetailAuthoritativeBody={name:'AppDetailAuthoritativeBody',render(){return null;}};");
