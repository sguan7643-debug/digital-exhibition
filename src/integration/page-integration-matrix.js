...
export const PAGE_INTEGRATION_MATRIX = Object.freeze([
  ...
  define('08','/apps/tool-001',['APP-003','APP-009'],['application-detail','training-relation','material-relation']),
  define('09','/apps/haineng-work-001',['APP-003','APP-009'],['application-detail','training-relation','material-relation']),
  define('10','/apps/report-001',['APP-003','APP-009'],['application-detail','report-metadata','related-resource']),
  define('11','/apps/dashboard-001',['APP-003','APP-009'],['application-detail','dashboard-metadata','related-resource']),
  define('12','/apps/dataset-001',['APP-003','APP-009'],['application-detail','dataset-metadata','related-resource']),
  define('13','/apps/metric-001',['APP-003','APP-009'],['application-detail','metric-metadata','related-resource']),
  define('14','/apps/ai-001',['APP-003','APP-009'],['application-detail','ai-metadata','related-resource']),
  define('15','/apps/ead-001',['APP-003','APP-009'],['application-detail','ead-metadata','related-resource']),
  define('16','/apps/rpa-001',['APP-003','APP-009'],['application-detail','rpa-metadata','related-resource']),
