...
@media(min-width:761px) and (max-width:1000px){.topbar{padding-inline:4px}.brand{flex-basis:125px;font-size:12px}.primary-nav{overflow:hidden}.primary-nav a{min-width:0;flex:1 1 0;gap:2px;padding-inline:1px;font-size:8px}.nav-glyph{width:14px;height:16px}.top-actions{flex-basis:109px;gap:4px}.action-link{width:20px}.action-icon{width:18px;height:18px}.top-user{flex-shrink:0;gap:4px;padding-left:4px}.top-user>img{width:26px;height:26px}.top-user strong{font-size:9px}}
