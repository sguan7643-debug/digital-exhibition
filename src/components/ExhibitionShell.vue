...
@media(max-width:1420px){.brand{flex-basis:160px}.primary-nav{overflow-x:auto;scrollbar-width:thin}.primary-nav a{flex:0 0 auto;min-width:72px;padding-inline:5px}.top-actions{flex-basis:205px}.top-user small{display:none}}@media(max-width:1100px){.primary-nav{overflow-x:auto}.page-frame{grid-template-columns:220px minmax(0,1fr)}.sidebar{overflow-y:auto}}@media(max-width:760px){.topbar{height:auto;min-height:69px;flex-wrap:wrap;padding-block:7px}.brand{flex:1}.top-actions{flex-basis:auto}.primary-nav{order:3;width:100%;overflow-x:auto}.primary-nav a{flex:0 0 auto;height:44px}.page-frame,.standard-shell .page-frame{grid-template-columns:1fr}.sidebar{min-height:auto;border-right:0;border-bottom:1px solid #dce4ed}.simple-nav{display:flex;overflow-x:auto;padding-top:0}.simple-nav a{flex:0 0 auto;height:48px;padding:0 14px;border-left:0;border-bottom:3px solid transparent}.simple-nav a[aria-current='page']{border-bottom-color:#096ef0}.simple-nav a.sub{padding-left:14px}}
