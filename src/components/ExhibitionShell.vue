...
const categories = [
  ['RPA', '/assets/overview-rpa.png'], ['大屏', '/assets/overview-ead.png'], ['驾驶舱', '/assets/hot-supplier.png'],
  ['可视化报表', '/assets/overview-report.png'], ['指标', '/assets/hot-inventory.png'], ['数据集', '/assets/overview-dataset.png'],
  ['AI', '/assets/overview-ai.png'], ['海能work应用', '/assets/overview-other.png']
];
  ...
  <div class="exhibition-shell" :class="{ 'standard-shell': !isCatalogue }">
    ...
    <header class="topbar">
      ...
      <div class="top-actions" aria-label="快捷操作">
        <a class="action-link" href="/messages" aria-label="8 条未读消息"><img src="/assets/top-message.png" width="32" height="31" alt="" /><small>消息</small></a>
        <a class="action-link" href="/favorites"><img :src="props.page.id === '03' ? '/assets/top-favorite-active.png' : '/assets/top-favorite.png'" width="26" height="28" alt="" /><small>收藏</small></a>
        <a class="top-user" href="/profile">
          <img src="/assets/top-avatar.png" width="43" height="43" alt="" />
...
.top-actions{flex:0 0 250px;height:100%;display:flex;align-items:center;justify-content:flex-end;gap:16px;white-space:nowrap}.action-link{min-width:30px;height:54px;position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1px;color:#132a4c}.action-link>img{object-fit:contain}.action-link small{font-size:10px}.top-user{height:44px;display:flex;align-items:center;gap:8px;padding-left:13px;border-left:1px solid #dbe3ec}.top-user>img{border-radius:50%}.top-user span{display:grid;gap:2px}.top-user strong{color:#132a4c;font-size:13px}.top-user small{color:#74869a;font-size:9px}
...
.simple-nav{display:grid;padding-top:21px}.simple-nav a{height:58px;display:flex;align-items:center;gap:15px;padding:0 21px;color:#1d3353;border-left:3px solid transparent;font-size:14px;font-weight:600}.simple-nav a>img{width:22px;height:24px;object-fit:contain}.simple-nav a[aria-current='page']{color:#0869ee;background:#eaf2ff;border-left-color:#096ef0}.simple-nav a.sub{height:40px;padding-left:60px;color:#607088;font-size:12px;font-weight:400}.simple-nav a.sub[aria-current='page']{color:#0869ee}
...
.standard-shell .topbar{height:79px}.standard-shell .page-frame{min-height:calc(100vh - 79px);grid-template-columns:232px minmax(0,1fr)}.standard-shell .sidebar{min-height:calc(100vh - 79px)}.standard-shell .simple-nav{padding-top:17px}.standard-shell .simple-nav a{height:59px;padding-left:20px}.standard-shell .brand{flex-basis:277px}
