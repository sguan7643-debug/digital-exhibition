...
const cards = computed(() => props.variant === 'dashboard' ? [
  { title:'经营目标达成', period:'2026年8月', label:'年度目标完成率', value:'78.6%', change:'同比 +4.2%', bars:[48,61,57,69,74,82] },
  { title:'产量与成本趋势', period:'近6个月', label:'油气当量产量', value:'3,286 万吨', change:'计划达成 101.4%', bars:[54,58,66,63,72,79] },
  { title:'区域运营对比', period:'截至 08-31', label:'重点单位达标数', value:'18 / 22', change:'较上月 +2 家', bars:[72,52,80,66,61,76] }
] : [
  { title:'收入与利润总览', period:'2026年8月', label:'累计营业收入', value:'1,286.4 亿元', change:'同比 +8.6%', bars:[42,55,51,64,71,78] },
  { title:'月度经营趋势', period:'2026年1—8月', label:'利润总额', value:'186.7 亿元', change:'预算达成 103.2%', bars:[44,48,53,59,56,68] },
  { title:'业务结构分析', period:'截至 08-31', label:'核心业务贡献率', value:'72.8%', change:'同比 +3.1%', bars:[64,71,56,78,68,83] }
]);
</script>
...
<template>
  <div class="business-previews" :data-variant="variant">
    <article v-for="(card,index) in cards" :key="card.title" class="business-preview">
      ...
      <svg viewBox="0 0 360 122" role="img" :aria-label="`${card.title}趋势图`">
