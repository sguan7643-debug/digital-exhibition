...
.talent-body form{height:auto;grid-template-columns:224px repeat(4,124px) 68px 68px;gap:16px}.talent-body form input,.talent-body form select,.talent-body form button{height:36px;font-size:14px}.talent-body form label{font-size:14px}.talent-body.drawer-open{grid-template-columns:minmax(0,1fr) clamp(520px,38vw,680px)}
.talent-table-scroll{max-width:100%;overflow-x:auto}.talent-body table{width:100%;min-width:1412px;table-layout:fixed;border-collapse:collapse;font-size:13px;line-height:20px}.talent-body th,.talent-body td{padding:0 16px}.talent-body th{height:48px;font-weight:600}.talent-body td{height:53px;font-weight:400}.talent-body th:nth-child(1){width:84px}.talent-body th:nth-child(2){width:52px}.talent-body th:nth-child(3){width:96px}.talent-body th:nth-child(4){width:120px}.talent-body th:nth-child(5){width:104px}.talent-body th:nth-child(6){width:96px}.talent-body th:nth-child(7){width:104px}.talent-body th:nth-child(8){width:146px}.talent-body th:nth-child(9){width:104px}.talent-body th:nth-child(10),.talent-body th:nth-child(11){width:126px}.talent-body th:nth-child(12){width:108px}.pool-status::before{content:'';display:inline-block;width:6px;height:6px;margin-right:6px;border-radius:50%;background:#1db36a}.pool-status.is-inactive::before{background:#ea3d48}.talent-tags{padding:3px 6px;color:#0870e8;background:#eaf3ff;border-radius:3px}
.talent-people{padding:12px 8px}.talent-body{margin-top:31px}.talent-body form{margin-bottom:23px}
@media(max-width:1054px){.talent-people,.talent-body,.talent-body>main,.talent-body main>section{min-width:0;max-width:100%}.talent-body{grid-template-columns:minmax(0,1fr)}.talent-body main>section{overflow:visible}.talent-body form{width:100%;max-width:100%;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px 16px}.talent-body form label,.talent-body form input,.talent-body form select,.talent-body form button{width:100%;min-width:0}.talent-table-scroll{width:100%;min-width:0;max-width:100%;overflow-x:auto}.talent-body :deep(.pagination-control){min-width:0;max-width:100%;flex-wrap:wrap}}
</style>
