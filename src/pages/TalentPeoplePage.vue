...
.talent-body form{height:auto;grid-template-columns: minmax(260px, 1.5fr) repeat(4, minmax(160px, 1fr)) 80px 80px;gap:10px}.talent-body.drawer-open{grid-template-columns: minmax(0, 1fr) clamp(520px, 38vw, 680px)}.talent-body form input,.talent-body form select,.talent-body form button{height:38px;font-size:13px}.talent-body form label{font-size:13px}
</style>
