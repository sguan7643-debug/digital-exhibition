  ...
  <article class="product-detail rpa-detail" aria-labelledby="rpa-title">
    ...
    <header class="detail-hero">
      <div class="detail-hero-main">
        <span class="detail-logo detail-type-icon" role="img" :aria-label="`${app.name}图标`"><TypeLineIcon name="rpa" :size="34" /></span>
        <div class="detail-title">
          <h1 id="rpa-title">{{ app.name }}</h1>
    ...
    <section class="detail-panel detail-panel--half">
      ...
      <table class="file-list rpa-training-list">
        ...
        <tbody>
          ...
          >
            <td>
              <img src="/assets/rpa-video.png" width="45" height="16" alt="" />
            </td>
            <td>{{ item[0] }}</td>
            <td>时长：{{ item[1] }}</td>
            <td>
