...
<style scoped>
.portal-page{min-height:calc(100vh - 63px);padding:17px 27px 24px;color:#1a3151}.page-heading{min-height:61px;display:flex;align-items:flex-start;justify-content:space-between}.page-heading h1{margin:0 0 5px;font-size:24px}.page-heading p{color:#506680;font-size:12px}.page-heading>button,.filters button,.page-heading+button{height:36px;padding:0 20px;border:0;color:#fff;background:#0060a6;border-radius:4px}.stat-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:14px;margin:5px 0 14px}.stat-grid article{height:120px;display:flex;align-items:center;gap:21px;padding:18px 28px;background:#fff;border:1px solid #dce5ee;border-radius:5px}.stat-grid article>span,.square-icon,.large-icon,.profile-actions a>span,.points-cards article>span,.admin-layout li>span,.cert-grid article>span{display:grid;place-items:center;color:#fff;border-radius:50%}.stat-grid article>span{width:58px;height:58px;font-size:24px}.stat-grid article div{display:grid;gap:3px}.stat-grid small{font-size:12px}.stat-grid strong{font-size:24px}.stat-grid em{color:#159447;font-size:11px;font-style:normal}.tone-0{background:#0060a6}.tone-1{background:#ff8a00}.tone-2{background:#12a95d}.tone-3{background:#6c34d9}
...
.table-panel,.card-panel,.profile-layout>section,.notice-detail,.app-detail,.onboarding,.points-layout>section,.operations-layout,.editor-form,.admin-layout>section,.cert-grid article{background:#fff;border:1px solid #dce5ee;border-radius:5px}.tabs{height:52px;display:flex;align-items:flex-end;gap:36px;padding:0 20px;border-bottom:1px solid #e1e8ef}.tabs button{height:45px;border:0;color:#2a3e5a;background:transparent}.tabs button[aria-current=page]{color:#0060a6;border-bottom:3px solid #0060a6}.message-list{list-style:none;margin:0;padding:0 20px}.message-list li{min-height:68px;display:grid;grid-template-columns:43px 90px 12px minmax(240px,1fr) 110px 45px 95px;align-items:center;gap:11px;border-bottom:1px solid #e1e7ee}.square-icon{width:40px;height:40px;border-radius:6px}.message-list li>small{font-size:11px}.message-list li>i{width:7px;height:7px;background:#0060a6;border-radius:50%}.message-list li strong,.message-list li p{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.message-list li strong{font-size:12px}.message-list li p{margin-top:5px;color:#687b91;font-size:10px}.message-list time,.message-list em{color:#546b84;font-size:11px;font-style:normal}.message-list li>a{color:#0060a6;font-size:11px}
.content-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;padding:20px}.content-cards article{min-height:176px;position:relative;display:flex;gap:14px;padding:20px;border:1px solid #dce5ee;border-radius:6px}.large-icon{width:54px;height:54px;flex:0 0 54px;border-radius:8px}.content-cards h2{margin:2px 0 7px;font-size:14px}.content-cards mark{color:#0060a6;background:#e8f2ff;font-size:10px}.content-cards p{margin:10px 0;color:#687b91;font-size:11px;line-height:1.7}.content-cards small{color:#74869b;font-size:10px}.content-cards article>a{position:absolute;right:18px;bottom:17px;color:#0060a6;font-size:11px}
.profile-layout{display:grid;grid-template-columns:1fr 1fr;gap:14px}.profile-card{grid-column:1/-1;display:flex;align-items:center;gap:22px;padding:22px}.profile-card img{border-radius:50%}.profile-card h2{margin:0 0 10px;font-size:18px}.profile-card mark{color:#0060a6;background:#e8f3ff;font-size:10px}.profile-card p{margin-top:7px;color:#60738a;font-size:11px}.profile-actions{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.profile-actions a{height:92px;display:flex;align-items:center;gap:14px;padding:16px;background:#fff;border:1px solid #dce5ee;border-radius:5px}.profile-actions a>span{width:44px;height:44px}.profile-actions a>b{font-size:13px}.profile-actions a>i{margin-left:auto;font-style:normal}.profile-list{padding:18px}.profile-list h2{margin:0 0 12px;font-size:15px}.profile-list ul{list-style:none;margin:0;padding:0}.profile-list li{display:flex;justify-content:space-between;padding:11px 0;border-bottom:1px solid #edf1f5;font-size:11px}.profile-list time{color:#8593a2}
table{width:100%;border-collapse:collapse;font-size:11px}th,td{height:52px;padding:0 15px;border-bottom:1px solid #e5ebf1;text-align:left}th{height:44px;color:#405672;background:#f7f9fc}td mark{color:#169154;background:#e7f8ef;border-radius:3px}td a{color:#0060a6}.table-panel footer{height:58px;display:flex;align-items:center;justify-content:space-between;padding:0 18px;font-size:11px}.table-panel footer nav{display:flex;gap:6px}.table-panel footer button{width:31px;height:31px;border:1px solid #d5dfe9;background:#fff;border-radius:4px}.table-panel footer button[aria-current=page]{color:#fff;background:#0060a6}
.notice-detail{padding:20px 26px}.notice-detail nav{color:#73869b;font-size:11px}.notice-detail h2{margin:15px 0 9px;font-size:22px}.notice-detail .meta{padding-bottom:17px;border-bottom:1px solid #e3e9f0;color:#77889b;font-size:10px}.notice-hero{height:125px;display:flex;flex-direction:column;justify-content:center;padding-left:32px;margin:20px 0;background:linear-gradient(100deg,#d9eeff,#f4faff);color:#0060a6}.notice-hero span{font-size:24px;font-weight:700}.notice-hero b{margin-top:10px;font-size:12px}.notice-detail>p,.notice-detail li{color:#4c617a;font-size:12px;line-height:2}.notice-detail aside{display:grid;gap:8px;margin-top:20px;padding:16px;background:#f8fafc}.notice-detail aside h3{margin:0}.notice-detail aside a{color:#0060a6;font-size:11px}
.app-detail{padding:15px}.app-detail>header{display:flex;align-items:center;gap:14px;padding:13px;border-bottom:1px solid #e1e8ef}.app-logo{width:62px;height:62px;display:grid;place-items:center;color:#fff;border-radius:10px;font-weight:700}.app-logo.blue{background:#0060a6}.app-logo.purple{background:#6936dc}.app-logo.green{background:#13a95c}.app-logo.orange{background:#f18a22}.app-detail>header div{flex:1}.app-detail>header h2{margin:0 0 4px;font-size:18px}.app-detail>header p{color:#61758c;font-size:11px}.app-detail>header mark{color:#0060a6;background:#e7f2ff;font-size:10px}.app-detail>header button{height:34px;padding:0 22px;border:0;color:#fff;background:#0060a6;border-radius:3px}.app-detail>header button.secondary{color:#0060a6;background:#fff;border:1px solid #79acf2}.app-metrics{display:grid;grid-template-columns:repeat(5,1fr);padding:18px 0;border-bottom:1px solid #e1e8ef}.app-metrics span{display:grid;gap:7px;text-align:center;border-right:1px solid #e1e8ef}.app-metrics span:last-child{border-right:0}.app-metrics small{color:#687a90;font-size:10px}.app-metrics strong{font-size:16px}.app-detail>section{padding:16px 6px;border-bottom:1px solid #e1e8ef}.app-detail>section h3{margin:0 0 10px;color:#0060a6;font-size:14px}.app-detail>section p{color:#52677f;font-size:11px;line-height:1.8}.preview-block{height:130px;display:grid;grid-template-columns:repeat(3,1fr);gap:15px;margin-top:10px}.preview-block span{display:grid;place-items:center;color:#fff;background:linear-gradient(135deg,#073575,#138cdb);border-radius:4px}
.onboarding{min-height:255px;padding:28px}.onboarding h2{margin:0 0 35px;font-size:16px}.onboarding ol{list-style:none;display:flex;margin:0;padding:0}.onboarding li{flex:1;position:relative;display:grid;justify-items:center;gap:8px;text-align:center}.onboarding li::after{content:'';position:absolute;left:60%;right:-40%;top:16px;height:2px;background:#cfdbe8}.onboarding li:last-child::after{display:none}.onboarding li>span{width:34px;height:34px;z-index:1;display:grid;place-items:center;color:#58708d;background:#fff;border:2px solid #cbd8e5;border-radius:50%}.onboarding li.done>span{color:#fff;background:#0060a6;border-color:#0060a6}.onboarding li.current>span{color:#fff;background:#ef534f;border-color:#ef534f}.onboarding strong{font-size:12px}.onboarding small{color:#7e8e9f;font-size:10px}
.points-layout{display:grid;grid-template-columns:1fr 1fr;gap:14px}.points-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.points-cards article{display:grid;justify-items:center;gap:9px;padding:23px;background:#fff;border:1px solid #dce5ee;border-radius:5px}.points-cards article>span{width:48px;height:48px}.points-cards h2{margin:0;font-size:12px}.points-cards strong{font-size:21px}.points-cards progress{width:80%;height:7px}.points-layout>section{padding:18px}.points-layout>section h2{margin:0;font-size:15px}.points-layout ul{list-style:none;margin:10px 0 0;padding:0}.points-layout li{display:grid;grid-template-columns:1fr 75px 90px;padding:10px;border-bottom:1px solid #e8edf2;font-size:11px}.points-layout li b{color:#0060a6}.points-layout li time{color:#78899d}
...
.editor-form{padding:15px}.editor-form section{padding:12px 5px;border-bottom:1px solid #e3e9ef}.editor-form h2{margin:0 0 16px;color:#0060a6;font-size:14px}.editor-form label{display:flex;align-items:center;gap:16px;margin:11px 0;font-size:11px}.editor-form label>span{width:120px;text-align:right}.editor-form label b{color:#e33}.editor-form input,.editor-form textarea{flex:1;padding:9px;border:1px solid #d5e0ea;border-radius:3px}.editor-form footer{display:flex;justify-content:center;gap:12px;padding:18px}.editor-form button{height:34px;min-width:92px;border:1px solid #8ab7f2;color:#0060a6;background:#fff;border-radius:3px}.editor-form button:first-child{color:#fff;background:#0060a6}
.admin-layout{display:grid;grid-template-columns:1fr 1fr;gap:15px}.admin-layout>section{padding:16px}.admin-layout h2{margin:0 0 14px;color:#0060a6;font-size:14px}.admin-layout ul{list-style:none;margin:0;padding:0}.admin-layout li{height:54px;display:flex;align-items:center;gap:12px;border-bottom:1px solid #e4eaf0;font-size:11px}.admin-layout li>span{width:30px;height:30px}.admin-layout li>b{flex:1}.admin-layout label{display:flex;align-items:center;gap:6px}.admin-layout a{color:#0060a6}.cert-hero{height:230px;padding:50px 43px;background:linear-gradient(110deg,#e7f5ff,#cce8ff);border-radius:5px}.cert-hero span{color:#193d6b;font-size:28px;font-weight:700}.cert-hero p{max-width:650px;margin:17px 0;color:#416486;line-height:1.8}.cert-hero button{height:37px;padding:0 25px;border:0;color:#fff;background:#0060a6;border-radius:3px}.cert-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:14px}.cert-grid article{padding:20px}.cert-grid article>span{width:42px;height:42px}.cert-grid h2{font-size:14px}.cert-grid p{color:#6f8194;font-size:11px}.cert-grid a{color:#0060a6;font-size:11px}
.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}button:focus-visible,a:focus-visible{outline:3px solid #ff9f1a;outline-offset:2px}
