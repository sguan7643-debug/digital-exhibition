      ...
      <div class="detail-hero-main">
        ...
        <div class="detail-title">
          ...
          <div class="detail-tags">
            ...
            ><mark>智能问答</mark><mark>效率工具</mark><mark>知识提取</mark>
          </div>
      ...
      <table class="ai-table">
        ...
        <tbody>
          ...
          <tr>
            <th>应用简介</th>
            <td>
              基于先进的自然语言处理技术，帮助用户快速提取长文本核心要点，生成结构化总结，提升信息处理效率。
            </td>
          </tr>
          <tr>
            <th>所属业务域</th>
          ...
          <tr>
            <th>应用描述</th>
            <td>
              用于长篇文档摘要、提炼、会议记录等文本的智能处理，支持多种格式文本输入。
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <div class="training-row">
        <article v-for="(name, index) in training" :key="name">
          <img
            ...
            alt=""
            :style="{ objectPosition: `${index * 33}% center` }"
          />
          <div>
            <h3>{{ name }}</h3>
            <p>时长：13:40</p>
