<script setup>
import RemoteAppDetailPage from '../components/RemoteAppDetailPage.vue';
...
const projection = useAppDetailProjection(props);
</script>

<template>
  <RemoteAppDetailPage :projection="projection" icon="dataset" />
</template>
