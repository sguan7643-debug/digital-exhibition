...
const fields = [
  ["供应商编码", "supplier_id", "字符串"],
  ["供应商名称", "supplier_name", "字符串"],
  ["统一社会信用代码", "credit_code", "字符串"],
  ["企业类型", "enterprise_type", "字符串"],
  ["注册资本(万元)", "registered_capital", "数值"],
  ["成立日期", "establish_date", "日期"],
  ["联系人姓名", "contact_name", "字符串"],
  ["联系电话", "contact_phone", "字符串"],
  ["供应商分类", "supplier_category", "字符串"],
  ["供应商等级", "supplier_level", "字符串"],
];
</script>
<template>
  <article
  ...
  >
      ...
      <div class="detail-hero-main">
        ...
        <div class="detail-title">
          ...
          <div class="detail-tags">
            <strong>应用关键词</strong><mark>供应商主数据</mark
            ><mark>采购管理</mark><mark>资质管理</mark><mark>风险监控</mark
            ><mark>数据分析</mark>
          </div>
        </div>
    ...
    <section class="detail-panel detail-panel--half">
      ...
      <dl class="info-grid">
        <div class="wide">
          <dt>应用编码</dt>
          <dd>
            供应商基础信息数据集整合了集团及各单位所属的各级单位与下属信息，提供接口获取服务采用。
          </dd>
        </div>
        <div>
          <dt>适用对象</dt>
          <dd>采购人员、供应商管理人员、风险人员、数据分析人员</dd>
        </div>
        <div>
          <dt>所属领域</dt>
          <dd>供应商管理</dd>
        ...
        <div>
          <dt>应用场景</dt>
          <dd>
            供应商注册与准入、采购寻源与比价、供应商绩效评价、风险监控与预警
          </dd>
        </div>
        <div>
          <dt>更新频率</dt>
          <dd>T+1 增量更新，关键字段实时同步</dd>
        </div>
      </dl>
    </section>
    <section class="detail-panel detail-panel--half">
      <h2>数据列表 <a href="#main-content">查看全部字段（12）</a></h2>
      ...
      <a class="more" href="#main-content">查看更多数据列表</a>
    </section>
        ...
        <tbody>
          <tr
            v-for="(name, index) in [
              '供应商基础信息数据模板.xlsx',
              '供应商基础信息数据集-样例数据.csv',
              '供应商基础信息数据集-画像关系图.png',
            ]"
            :key="name"
          >
            <td>{{ name }}</td>
            <td>{{ 856 + index * 220 }} KB</td>
            <td>2025-05-06 10:{{ 32 + index }}:10</td>
            <td>张三丰</td>
            <td><a href="#main-content">下载</a></td>
          </tr>
        </tbody>
      </table>
    </section>
    <section class="detail-panel detail-panel--half">
      <h2>相关培训内容</h2>
      <img
        class="preview-wide dataset-training"
        src="/assets/dataset-training.png"
        width="410"
        height="140"
        alt="供应商数据集培训视频封面"
      />
      ...
      <div class="related-row">
        ...
        >
          <img
            :src="
              [
                '/assets/dataset-logo.png',
                '/assets/app-rpa.png',
                '/assets/app-cockpit.png',
              ][index]
            "
            alt=""
          />
