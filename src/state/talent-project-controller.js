...
export function createTalentProjectController(fixtures){
  ...
  return reactive({
    fixtures:originals.map(item=>({...item})),filters:{query:'',progress:'',domain:'',manager:'',status:''},page:1,pageSize:5,drawerOpen:false,mode:'create',selectedId:null,draft:emptyDraft(),errors:{},firstError:'',announcement:'',
